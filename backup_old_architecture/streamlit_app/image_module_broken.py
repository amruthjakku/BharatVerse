...
def image_page():
    ...
    if uploaded_file is not None:
        ...
        # Manual description section (always available)
        st.markdown("---")
        st.markdown("### ✏️ Manual Description")
        st.info("You can also provide a manual description regardless of AI analysis results.")
